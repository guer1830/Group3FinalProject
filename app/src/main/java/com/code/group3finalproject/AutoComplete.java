...
public class AutoComplete  extends androidx.appcompat.widget.AppCompatAutoCompleteTextView {

    public TempAdapter adapter = null;
    public boolean userSelect = false;
    public AddStockActivity act = null;
    ...
    private void init(Context context){
        act = (AddStockActivity) context;
        adapter = new TempAdapter(context);
        setAdapter(adapter);
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(!userSelect)
                {
                    new RequestTask().execute("https://www.alphavantage.co/query="+s.toString()+"&apikey=A17S0FRD7LSUFI01");
                }
                else {
                    userSelect = false;
                }
    ...
    class TempAdapter extends BaseAdapter implements Filterable {
        List<String> mList;
